    ...
    >
      <div className="card-wrapper absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full animate-[floating_3s_ease-in-out_infinite]">
        <div className="flip-card-inner  ">
          ...
          <div className="flip-card-back absolute w-full h-full backface-hidden md:px-5 px-3 text-black rounded-xl shadow-white overflow-hidden font-inter md:gap-3 gap-2 bg-[#fc8c14] rotate-y-180 flex flex-col items-center justify-center">
            <p
            ...
            src={obj.cardimg}
            alt={frontAlt+ " back"} 
            className={`md:h-[150px] h-[75px] w-[75px] md:w-[150px] mix-blend-multiply `}
            />

             <span className={`text-[10px] md:text-sm text-start opacity-60 `}>
              {obj.subHeading}
             </span>
          </div>
        </div>
