      ...
      >
        ...
        >
          ...
          <h1 className=" md:text-[4.5rem] xl:text-[5.3rem] my-1.5 text-[2rem] leading-[1.1] font-normal md:tracking-[-0.01em] xl:tracking-[0.01em] md:text-center text-start text-[#FEE0D7]  xl:mb-6 px-1  ">
            ...
            <br />
            <span className="mb-0.5 ">that grow sales</span>
            <div className="flex items-start justify-start mt-1 md:justify-center md:items-center ">
              ...
              <img
                ...
                alt="headache"
                className={`w-6 -top-1 translate-y-3`}
              />
            </div>
          </h1>
        </div>
