...
export default function Footer() {
  return (
    <footer className="relative min-h-[50vh] font-inter w-full bg-[#f89c56] flex flex-col justify-between py-10 ">
      ...
      <div className="flex items-center justify-between w-[88vw] mx-auto mt-[2vw] mb-[2vw]">
        ...
        <div className="flex items-center gap-[2.5vw]">
          {/* Twitter */}
          <img width="24" height="24" src="https://img.icons8.com/ios/50/twitterx--v2.png" alt="twitterx--v2"/>
          {/* YouTube */}
          <img width="24" height="24" src="https://img.icons8.com/material-outlined/24/youtube-play--v1.png" alt="youtube-play--v1"/>
          {/* LinkedIn */}
      ...
      <div className="flex items-end justify-between w-[88vw] mx-auto mb-[1.5vw] mt-[2vw] text-[1rem] text-black/90">
        ...
        <span className="text-xs font-normal text-black/40">
          Copyright <span className="align-middle">©</span> 2025 Designstein<span className="align-middle">.</span> All rights reserved.
        </span>
        {/* Policy Links */}
        <div className="flex gap-[2vw] ">
          <a href="/" className="text-xs text-black/40 hover:underline">Privacy Policy</a>
          <a href="/" className="text-xs text-black/40 hover:underline">Term of Use</a>
        </div>
      </div>
    </footer>
  );
